...
public class kbcupdate
{
 ...
 double id,mobileno;
   ...
   if(choice==1){
    ...
    System.out.println("You Are Eliminated You Chose The Wrong Answer !");
    System.exit(0);
    ...
    res=sc.next();
    if(res.equalsIgnoreCase("n")==true){
        System.out.println("Thanks For Playing KBC Show With Us Visit Us Again !");
    System.exit(0);
...
System.out.println("Do Want To Continue>< Press (y)for yes (n) for no");
   ...
   public void  check14(){
    ...
    ob.option3(); 
     ...
     ob.check14();
     System.out.println("........................................");
     System.out.println("Thanks For Playing KBC Show With Us !");
    }
}
